...
flares_and_spots = flares_and_spots[['year_x','zurich', 'penumbra', 'compactness','x_ray_class']]             

associated_len =  len(flares_and_spots.zurich)
flares_and_spots['association'] =  ['associated' for i in range(1, associated_len + 1)]         
flares_and_spots[flares_and_spots.year_x == 2000].to_csv('C:\\Users\\Craig\Documents\\Python_DS\\GA_DS\\DAT4-students\\craig\\associated_2000.csv')
...
unassociated_spots_time_index = unassociated_spots_time_index[['year','zurich', 'penumbra', 'compactness']]
...
unassociated_spots_time_index[unassociated_spots_time_index.year == 2000].to_csv('C:\\Users\\Craig\Documents\\Python_DS\\GA_DS\\DAT4-students\\craig\\unassociated_2000.csv')
