...
associated_df = pd.read_csv('C:\\Users\\Craig\\Documents\\Python_DS\\GA_DS\\DAT4-students\\craig\\associated.csv')
not_associated_df = pd.read_csv('C:\\Users\\Craig\\Documents\\Python_DS\\GA_DS\\DAT4-students\\craig\\unassociated.csv')
...
#all_groups['association'] = all_groups.association.map({0.1:0, 0.9:1})

X = all_groups.iloc[:,:3]
y = all_groups.association
