...
##  Interesting Fact #1:
##  There are 282 films with a runtime of 00 mins. These need to be recoded to NA.
    data.runtime.value_counts()

##  Interesting Fact #2:
##  Reality TV is apparently a type of movie, and these generally are rated lower and have shorter run times than average.
