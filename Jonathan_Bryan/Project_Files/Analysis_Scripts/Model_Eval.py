# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 21:11:04 2015
...
Adj_Num_AE.score(X_test, y_test)

# predict in one step, calculate accuracy in a separate step
preds = Adj_Num_AE.predict(X_test)
...
probs = Comp.predict_proba(X_test)[:, 1]
plt.hist(probs)
